...
## Restaurant-initiated order cancellation (BR-174)

| #      | Rule                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| BR-174 | A restaurant (MANAGER or OWNER, not STAFF) can cancel an order after accepting it — from ACCEPTED, PREPARING, or READY_FOR_PICKUP — requiring a reason and triggering a full refund, mirroring admin-initiated cancellation exactly. Differential cancellation charges (e.g. a partial refund once food preparation has started) are explicitly deferred — every restaurant-initiated cancellation refunds in full today, same as a pre-acceptance reject. |
